...
public class DB_Saluran {
    ...
    public DB_Saluran(
            int urut, int jenis, int kondisi, int kebun, String waktu, int userid, String ket, String cx,
            String cy, int kirim, String lebar, int dari_server, int id_server, int asli) {
        this.urut = urut;
        this.jenis = jenis;
