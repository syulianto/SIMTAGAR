...
public class frm_ld_saluran_IA extends BaseAdapter {
    /*********** Declare Used Variables *********/
    private Activity activity;
    private ArrayList data;
    private static LayoutInflater inflater=null;
    frm_ld_saluran_list tempValues=null;
    int i=0;

    /*************  CustomAdapter Constructor *****************/
    public frm_ld_saluran_IA(Activity a, ArrayList d) {
        /********** Take passed values **********/
        activity = a;
        data=d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View vi = convertView;
        frm_ld_saluran_IA.ViewHolder holder;

        if(convertView==null){

            /****** Inflate tabitem.xml file for each row ( Defined below ) *******/
            vi = inflater.inflate(R.layout.frm_ld_saluran_list, null);

            /****** View Holder Object to contain tabitem.xml file elements ******/

            holder = new frm_ld_saluran_IA.ViewHolder();
            holder.nourut = (TextView) vi.findViewById(R.id.ld_saluran_no);
            holder.jenis = (TextView) vi.findViewById(R.id.ld_saluran_jenis);
            holder.kondisi = (TextView) vi.findViewById(R.id.ld_saluran_kondisi);
            holder.lebar = (TextView) vi.findViewById(R.id.ld_saluran_lebar);
            holder.koord = (TextView) vi.findViewById(R.id.ld_saluran_koord);
            holder.ket = (TextView) vi.findViewById(R.id.ld_saluran_ket);
            holder.dariserver = (TextView) vi.findViewById(R.id.ld_saluran_dari_server);
            holder.kirim = (TextView) vi.findViewById(R.id.ld_saluran_kirim);

            /************  Set holder with LayoutInflater ************/
            vi.setTag( holder );
        }
        else
            holder=(frm_ld_saluran_IA.ViewHolder)vi.getTag();
        ...
        if(data.size()<=0) {
            ...
            tempValues=null;
            tempValues = (frm_ld_saluran_list) data.get( position );
