...
public class frm_jalan extends AppCompatActivity {
    ...
    List<DB_Ref_Jalan> setjalan = new LinkedList<DB_Ref_Jalan>();
    List<DB_Ref_Jalan_Kondisi> setkondisi = new LinkedList<DB_Ref_Jalan_Kondisi>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.frm_jalan);
        ...
        kondisi = (Spinner) findViewById(R.id.jalan_kondisi);
        jenis = (Spinner) findViewById(R.id.jalan_jenis);
        //kebun = (Spinner) findViewById(R.id.jalan_kebun);
        ket = (EditText) findViewById(R.id.jalan_ket);
        lebar = (EditText) findViewById(R.id.jalan_lebar);
        btn_ok = (Button) findViewById(R.id.jalan_proses);
        btn_cancel = (Button) findViewById(R.id.jalan_batal);
        ...
        setkondisi = sws_db.DBRefJalanKondisi_Get(0);
        ...
        setjalan = sws_db.DBRefJalan_Get(0);
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                sws_db.DBJalan_Add(jenis, kondisi, kebun, logdate, userid, aket, acx, acy, 0, alebar,0,0, 1);
