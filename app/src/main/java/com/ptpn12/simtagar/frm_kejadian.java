...
public class frm_kejadian extends AppCompatActivity {
    ...
    List<DB_Ref_Kejadian> setjalan = new LinkedList<DB_Ref_Kejadian>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.frm_kejadian);
        ...
        jenis = (Spinner) findViewById(R.id.kejadian_jenis);
        //kebun = (Spinner) findViewById(R.id.kejadian_kebun);
        ket = (EditText) findViewById(R.id.kejadian_ket);
        btn_ok = (Button) findViewById(R.id.kejadian_proses);
        btn_cancel = (Button) findViewById(R.id.kejadian_batal);
        ...
        setjalan = sws_db.DBRefKejadian_Get(0);
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                sws_db.DBKejadian_Add(kebun, jenis, aket, acx, acy, logdate, userid, 0,0,0, 1);
                Intent intent1=new Intent();
                setResult(1102,intent1);
                finish();
            }
        });
