...
public class frm_ld_jalan_IA extends BaseAdapter {
    /*********** Declare Used Variables *********/
    private Activity activity;
    private ArrayList data;
    private static LayoutInflater inflater=null;
    frm_ld_jalan_list tempValues=null;
    int i=0;

    /*************  CustomAdapter Constructor *****************/
    public frm_ld_jalan_IA(Activity a, ArrayList d) {
        /********** Take passed values **********/
        activity = a;
        data=d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            vi = inflater.inflate(R.layout.frm_ld_jalan_list, null);

            /****** View Holder Object to contain tabitem.xml file elements ******/

            holder = new ViewHolder();
            holder.nourut = (TextView) vi.findViewById(R.id.ld_jalan_no);
            holder.jenis = (TextView) vi.findViewById(R.id.ld_jalan_jenis);
            holder.kondisi = (TextView) vi.findViewById(R.id.ld_jalan_kondisi);
            holder.lebar = (TextView) vi.findViewById(R.id.ld_jalan_lebar);
            holder.koord = (TextView) vi.findViewById(R.id.ld_jalan_koord);
            holder.ket = (TextView) vi.findViewById(R.id.ld_jalan_ket);
            holder.dariserver = (TextView) vi.findViewById(R.id.ld_jalan_dari_server);
            holder.kirim = (TextView) vi.findViewById(R.id.ld_jalan_kirim);
        ...
        if(data.size()<=0) {
            ...
            tempValues=null;
            tempValues = (frm_ld_jalan_list) data.get( position );
